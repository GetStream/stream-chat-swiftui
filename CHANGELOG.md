...
- Fix giphy previews showing camera icon with "Photo" in quoted messages and "/giphy" in channel list instead of document icon with "Giphy" [#1333](https://github.com/GetStream/stream-chat-swiftui/pull/1333)
