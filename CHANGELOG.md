...
- Show the typing indicator at the bottom of the message list instead of the middle of the screen when a channel has no messages [#1545](https://github.com/GetStream/stream-chat-swiftui/pull/1545)
