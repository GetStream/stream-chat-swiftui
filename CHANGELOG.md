...
- Improve keyboard handling in the Create Poll sheet so the `Next` return key advances between fields and scrolling dismisses the keyboard [#1464](https://github.com/GetStream/stream-chat-swiftui/pull/1464)
