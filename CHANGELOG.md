...
- Move message text attributed-string building from `LinkDetectionTextView` into `MessageViewModel.messageFormattedText(layoutDirection:)` and introduce `MessageFormattedText` for handling formatted text [#1400](https://github.com/GetStream/stream-chat-swiftui/pull/1400)
