...
@MainActor public final class MessageListConfig {
    public init(
        ...
        shouldMessagesStartAtTheTop: Bool = true
    ) {
    ...
    /// Whether short message lists begin at the top instead of the bottom. Defaults to `true`.
...
public final class MessageDisplayOptions {
    ...
    public init(
        ...
        showOriginalTranslatedButton: Bool = true,
