...
@MainActor final class MessagePreviewFormatter_Tests: StreamChatTestCase {
    ...
    func test_attachmentIcon_voiceRecording() {
        ...
        let message = ChatMessage.mock(
            ...
            cid: .unique,
            text: "",
            attachments: [.dummy(type: .voiceRecording)]
        )
    ...
    func test_attachmentIcon_linkPreview() {
        ...
        let message = ChatMessage.mock(
            ...
            cid: .unique,
            text: "Check this",
            attachments: [.dummy(type: .linkPreview)]
        )
